<script>
  ...
  fdFncs.countBnr = function() {
        ...
        countBnr = (function () {
          ...
          */
          if (
               ...
               (fdFncs.vars.isTest >= '250116' && fdFncs.vars.isTest <= '250117')
            ) {
            var msgTime = '',
                addMsg = '';
            ...
            bgColor = 'black';
            digitBg = ' white';
            endDateLong = '01/18/2025';
            showCountdown = true;
            addMsg = ' + 60% off lenses';
            if ($(window).width() > 992) {
              bnrLnkClasses = bnrLnkClasses;
              msgTime = 'Winter Sale: ';
            }
            loggedIn = '<a href="/email/winter-sale-dp" class="color-white weight-bold">20% off frames'+addMsg+'</a>';
            ...
            var msgTime = 'Early Winter Sale: ',
                addMsg = '';
            bnrLnkClasses = bnrLnkClasses + ' color-white';
            bgColor = 'black';
            digitBg = ' white';
            if (checkDate >= '250114' || fdFncs.vars.isTest >= '250114') {
              endDateLong = '01/16/2025';
              showCountdown = true;
            }
            if ($(window).width() > 992) {
              bnrLnkClasses = bnrLnkClasses;
            ...
            if (isRecognized) {
              loggedIn = '<a href="/email/winter-sale-dp" class="color-white weight-bold">25% off frames'+addMsg+'</a>';
            } else {
    ...
    if (showBanner && (checkDate >= '250113' && checkDate <= '250115') || (fdFncs.vars.isTest >= '250113' && fdFncs.vars.isTest <= '250115')) {
